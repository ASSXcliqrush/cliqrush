    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/services/performance-marketing", changefreq: "monthly", priority: "0.9" },
          { path: "/services/website-development", changefreq: "monthly", priority: "0.9" },
          { path: "/services/content-marketing", changefreq: "monthly", priority: "0.9" },
          { path: "/services/video-creation", changefreq: "monthly", priority: "0.9" },
